...
icon_path = r"C:\Users\hp\Desktop\tkinter\projet\shopping-cart.png"
...
head = Label(main, text="> Purchases",
            font=("Arial", 20, "bold"),
            fg="white",
            bg="orange",
            pady=20,
...
# save button
save_btn = Button(main, text="Save Record", bg="black",
                font=("Arial", 14),fg="orange", command=save)
save_btn.place(x=80, y= 400, anchor=W, width=200, height=50)
save_btn.config(cursor="hand2")

# clear button
clear_btn = Button(main, text="Clear Entry", bg="black",
                    font=("Arial", 14),fg="orange", command=clear_entries)
clear_btn.place(x=290, y= 400, anchor=W, width=200, height=50)
clear_btn.config(cursor="hand2")

# remove row by id
remove_btn_by_id = Button(main, text="Remove by id", 
                        bg="black", font=("Arial", 14), 
                        fg="orange", command=remove_row_by_id)
...
remove_selected_item_btn = Button(main, text="Remove Selected Row", 
                                bg="black", font=("Arial", 13), 
                                fg="orange", command=remove_selected_row)
